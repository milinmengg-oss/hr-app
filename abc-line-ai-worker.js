...
- ส่งด่วน (เฉพาะ กทม.+ปริมณฑล) = คิดตามระยะทาง ⛔ จีทูห้ามกุตัวเลข ให้ขอหมุดแล้วบอกว่าแอดมินเช็คค่าส่งด่วนให้ค่ะ
...
- ⛔ ค่าส่งด่วนคิดตามระยะทาง ห้ามจีทูกุตัวเลขเอง — ถ้าลูกค้าเลือกส่งด่วน ให้ขอโลเคชั่น(ปักหมุด)มาก่อน แล้วบอกว่าแอดมินจะเช็คค่าส่งด่วน+รอบส่งให้ค่ะ (ห้ามระบุชื่อบริษัทขนส่ง)
