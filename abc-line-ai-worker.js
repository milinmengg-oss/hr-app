...
const BUILD = "2026-08-01-k62-cutoff18";
...
const LIQUID_MSG = "น้ำยาบุหรี่ไฟฟ้ามี 2 แบบหลักค่ะ 💧\n\n"
  ...
  + "สนใจแบบไหน บอกอัญญาได้เลยค่ะ เดี๋ยวเช็คกลิ่นที่มีของให้ทันทีค่ะ 💕";
...
function carryModel(text, hist) {
  try {
    ...
    for (let i = hist.length - 1; i >= 0 && i >= hist.length - 8; i--) {
      ...
      if (k) return " " + k;                              // เจอรุ่นล่าสุด → เติมเข้าไปให้ระบบดึงสต็อกได้
    }
  } catch (e) {}
  return "";
}
...
ลูกค้า: "ส่งกี่วัน"
"ABC ยินดีต้อนรับค่ะ ✨ น้องอัญญายินดีให้บริการค่ะ 💚
...
"🚚 ขนส่งเอกชน (พัสดุปกติ) ส่งทั่วประเทศ ค่าส่ง 40 บาท ได้รับภายใน 2-3 วัน · ตัดรอบส่งพัสดุ 18.00 น.
...
- 📦 พัสดุปกติ (ทั่วประเทศ): **รอบตัดพัสดุ 18.00 น.** — โอน+ยืนยันออเดอร์ก่อน 18.00 น. เข้ารอบของวันนั้น · หลัง 18.00 น. เข้ารอบวันถัดไป
  ร้านส่งออกภายใน 1-2 วันหลังชำระเงิน → จากวันส่งออกถึงภายใน 2-3 วัน · ค่าส่ง 40 บาท
  ⛔ รอบตัด 18.00 น. = รอบ "พัสดุปกติ" คนละอันกับรอบส่งด่วน 20.45 น. (ส่งด่วนเฉพาะ กทม./ปริมณฑล) ห้ามสลับกัน
...
"7) ถ้ารูปไม่มีการวง/ทำเครื่องหมายเลย → ถามว่า \"สนใจรุ่นไหนในภาพคะ 💕 บอกชื่อรุ่นกับกลิ่นมาได้เลยนะคะ\"" },
    ...
    try {
      ...
      // ⚠️ k58: เดิมเขียนกว้างไป ไปจับ "เดี๋ยวอัญญาเช็คให้ทันทีค่ะ" ซึ่งเป็นคำพูดปกติ
      ...
      if (/จะ(กลับมา)?แจ้ง(ให้ทราบ|ให้อีกครั้ง|ให้อีกที|กลับ)|กลับมาแจ้ง|แจ้งกลับ(ให้|ไป)|(รอ|อีก)สักครู่[^\n]{0,25}(จะ|แล้ว)[^\n]{0,10}แจ้ง|ระบบ(สต็อก)?กำลัง(อัปเดต|อัพเดต|ประมวลผล)|(แจ้ง|บอก)(ให้ทราบ|ให้)[^\n]{0,10}(ในภายหลัง|เร็วๆ ?นี้|ทีหลัง)/.test(reply)) {
        reply = "ขออภัยด้วยนะคะ 🙏🏻 ตอนนี้อัญญายังเช็ครายการให้ไม่ได้ค่ะ\n\nรบกวนบอกรุ่นที่สนใจมาได้เลยนะคะ เดี๋ยวอัญญาเช็คกลิ่นที่มีของให้ทันทีค่ะ 💕\nหรือดูรายการทั้งหมดที่มีของจริงได้จากเมนูนี้เลยค่ะ\nhttps://cutt.ly/menu4";
