...
- ซื้อครบ 1,000 บาทขึ้นไป → ส่งฟรี (เงื่อนไขนี้ยังใช้อยู่ตามปกติ)
...
async function handleEvent(ev, env, TOKEN, shopId) {
  try {
    ...
    if (mtype === "text") {
      ...
      // ทักทาย / เริ่มต้น → ส่งการ์ดต้อนรับ + ปุ่มเมนู
      if (/^(สวัสดี|หวัดดี|ดีครับ|ดีค่ะ|ดีคับ|ดีค้าบ|ดีจ้า|ทัก|เริ่ม|เมนูหลัก|hello|hi|hey|start)\b/i.test(t) || t === "ดี" || t === "เริ่มต้น") {
...
function btnDark(label, text) {
  return {
    type: "box", layout: "vertical", backgroundColor: "#22314F", cornerRadius: "14px",
