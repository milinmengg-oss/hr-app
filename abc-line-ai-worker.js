...
const BUILD = "2026-07-28-k4-abcwide";
...
"- ⛔ ABC ผลิตแต่หัวน้ำยา **ไม่ได้ผลิตเครื่อง** ห้ามเสนอ 'เครื่อง ABC' | หัว ABC TANK→เครื่อง M SWITCH · หัว ABC LEGO→เครื่อง BOOST POD (เลโก้)\n" +
