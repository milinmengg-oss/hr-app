...
const BUILD = "2026-08-03-k152-headfix";
    ...
    if (mtype === "text") {
      ...
      if (/แกร?[็ๆ]?[บป]|grab|ไรเดอร์|rider|มอเตอร์ไซค์|วินมอไซ|เมสเซนเจอร์|messenger|ลาลามูฟ|lalamove|ตามหมุด|ที่หมุด|ตามพิกัด/i.test(t)
        ...
        if (exp && exp.outzone) {
          ...
          await lineReply(TOKEN, replyToken, "ได้รับหมุดแล้วนะคะ 📍 ทีมงานกำลังเช็คค่าส่งด่วนให้อยู่ค่ะ เดี๋ยวแจ้งราคาทันทีนะคะ 🛵💕", userId);
