...
const BUILD = "2026-08-04-k163-nofakepromo";
      ...
      try {
        ...
        if (_intro && _bullets === 0 && _hintModels.length && _sm) {
          ...
          if (_have.length) {
            ...
            reply = "ต้องขออภัยด้วยนะคะ 🙏🏻 ตอนนี้ " + _mdl + " กลิ่นแนวที่คุณลูกค้าชอบยังไม่มีของค่ะ\n\nรบกวนบอกแนวกลิ่นหรือรุ่นอื่นที่สนใจมาได้เลยค่ะ เดี๋ยวแอดมินเช็คให้ทันที หรือดูรุ่นที่มีของทั้งหมดได้ที่เมนูนี้เลยค่ะ 💕\nhttps://cutt.ly/menu4";
