...
- 📦 พัสดุปกติ (ทั่วประเทศ): ร้านส่งออกภายใน 1-2 วันหลังชำระเงิน → จากวันส่งออกถึงภายใน 2-3 วัน · ค่าส่ง 40 บาท
...
"7) ถ้ารูปไม่มีการวง/ทำเครื่องหมายเลย → ถามว่า \"สนใจรุ่นไหนในภาพคะ 💕 บอกชื่อรุ่นกับกลิ่นมาได้เลยนะคะ\"" },
      ...
      const hint = _explainQ
        ...
        : (function () {
            ...
            let h = aliasHint(tForHint) + flavorHint(tForHint, smForHint, bufForHint) + brandHint(tForHint, smForHint, bufForHint) + legoHint(tForHint, smForHint, bufForHint);
